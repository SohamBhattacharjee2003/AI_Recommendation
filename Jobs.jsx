  ...
  return (
    <div className="bg-[#f4f6f8] min-h-screen flex">
      ...
      <motion.aside
        ...
        initial="hidden"
        animate="visible"
        className="bg-white border-r border-gray-200 w-64 flex-shrink-0 h-screen sticky top-0 overflow-y-auto p-6"
      >
        <Link className="flex items-center space-x-2 mb-8" to="/">
          <img src="/images/logo.png" alt="CareerCompass Logo" className="h-8 w-auto" />
        ...
        <nav className="mt-6">
          <ul className="space-y-3">
            <li>
              <Link to="/" className="flex items-center space-x-3 text-gray-700 hover:text-indigo-600 transition-colors duration-200">
                <i className="fas fa-home text-lg"></i>
                <span className="font-medium">Home</span>
              </Link>
            </li>
            <li>
              <Link to="/dashboard" className="flex items-center space-x-3 text-gray-700 hover:text-indigo-600 transition-colors duration-200">
                <i className="fas fa-tachometer-alt text-lg"></i>
                <span className="font-medium">Dashboard</span>
              </Link>
            </li>
            <li>
              <Link to="/jobs" className="flex items-center space-x-3 text-indigo-600 font-semibold">
                <i className="fas fa-briefcase text-lg"></i>
                <span className="font-medium">Jobs</span>
              </Link>
            </li>
            <li>
              <Link to="/account" className="flex items-center space-x-3 text-gray-700 hover:text-indigo-600 transition-colors duration-200">
        ...
        <div className="mt-auto">
          ...
          <div className="text-center text-gray-500 text-sm">
            <p>&copy; {new Date().getFullYear()} CareerCompass</p>
          </div>
        </div>
      </motion.aside>
              ...
              <table className="min-w-full divide-y divide-gray-200">
                ...
                >
                  {filteredJobs.map(job => (
                    <motion.tr key={job.id} variants={fadeInUp} whileHover={{ backgroundColor: "#f9fafb" }}>
                ...
                <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                  <div>
                    <p className="text-sm text-gray-700">
                      Showing <span className="font-medium">1</span> to <span className="font-medium">{filteredJobs.length}</span> of <span className="font-medium">{latestJobs.length}</span> results
                    </p>
                  </div>
                  <div>
                    <nav className="relative z-0 inline-flex rounded-md shadow-sm -space-x-px" aria-label="Pagination">
                      ...
                      <button aria-current="page" className="z-10 bg-indigo-50 border-indigo-500 text-indigo-600 relative inline-flex items-center px-4 py-2 border text-sm font-medium">1</button>
